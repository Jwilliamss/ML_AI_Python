...
shopping_list = ["milk", "suger", "orange", "banana", "veg"] # Fill in with some values
...
print("This is Trans fat ", nutrition_facts["Trans fat 0g"]) # Uncomment this line and pick a value to print individually
